...
<div class="contentWrap">
    <div class="content">
        ...
        <div class="box">
            ...
            <p></p>
            <label><input type="text" id="userAnswer"></label>
            <h3 id="result"></h3>
            <br>
